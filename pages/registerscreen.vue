<template>
  <div class="relative w-full min-h-screen flex justify-center items-center">
    ...
    <div
      class="relative z-10 w-full max-w-md mx-4 bg-white/45 backdrop-blur-md rounded-3xl shadow-2xl p-6 sm:p-8"
    >
      <div class="w-full h-full flex flex-col items-center gap-4">
        ...
        <div class="flex flex-col w-full">
          <div
            class="w-full h-[48px] flex items-center bg-white rounded-full px-4 shadow-sm bg-white/80"
          >
            <div class="flex items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <!-- อายุ  -->
        <div
          class="w-full h-[48px] flex items-center rounded-full px-4 opacity-80 shadow-sm bg-white/80"
        >
          <div class="flex items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex flex-col w-full">
          <div
            class="w-full h-[48px] flex items-center bg-white/80 rounded-full px-4 shadow-sm relative"
          >
            <!-- ซ้าย: ไอคอน + Password -->
