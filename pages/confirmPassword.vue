        ...
        <div class="w-[700px] h-auto bg-white/45 rounded-[70px] shadow-2xl relative z-20 p-5">
            <div class="w-full h-full flex flex-col items-center gap-4 ">
                ...
                <div
                    ...
                    <input type="text" placeholder="Password" class="flex-1 p-3 bg-transparent rounded-4xl w-[500px] focus:outline-none text-[#ffffff] font-extrabold text-shadow-2xl" />
                </div>
                <div
                    class="w-[500px] h-[50px] flex items-center bg-white/50 backdrop-blur-md border border-gray-300 rounded-4xl px-3">
                    <!-- <img src="/img/iconUser.png" class="w-5 h-5 opacity-70" /> -->
                    <input type="text" placeholder="Confirm Password" class="flex-1 p-3 bg-transparent rounded-4xl w-[500px] focus:outline-none text-[#ffffff] font-extrabold text-shadow-2xl" />
                </div>
